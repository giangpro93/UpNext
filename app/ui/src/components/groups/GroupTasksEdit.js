...
function editPost(){
  var updateData = {id: props.postId, title:eventName, location: eventLocation, description: eventDesc, assigned: format(toUTC(dateInputFormat(new Date(eventStart)))), due: format(toUTC(dateInputFormat(new Date(eventEnd))))}
